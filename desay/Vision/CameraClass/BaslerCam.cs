...
namespace PylonLiveViewer
{
    public class BaslerCam
    {
        ...
        public HObject ho_ImageNoglue = null;
...
/******************    实例化相机    ******************/
        ...
        public BaslerCam()
        {
            try
            {
                ...
                HOperatorSet.GenEmptyObj(out ho_ImageNoglue);
            }
            catch (Exception e)
            {
                ShowException(e);
        ...
        private void OnImageGrabbed(Object sender, ImageGrabbedEventArgs e)
        {
            try
            {
                ...
                if (grabResult.GrabSucceeded)
                {
                    ...
                    //eventComputeGrabTime(grabTime);//2020.8.31暂时屏蔽
                    ...
                    
                    {
                        ...
                        if (grabResult.PixelTypeValue == PixelType.Mono8)
                        {
                            ...
                            ho_Image.Dispose();
                            ho_ImageNoglue.Dispose();
                            // 转换为Halcon图像显示  imageWidth, imageHeight, latestFrameAddress
                            HOperatorSet.GenImage1(out ho_Image, "byte", (HTuple)imageWidth, (HTuple)imageHeight, (HTuple)latestFrameAddress);
                            HOperatorSet.GenImage1(out ho_ImageNoglue, "byte", (HTuple)imageWidth, (HTuple)imageHeight, (HTuple)latestFrameAddress);
                                    ...
                                    || grabResult.PixelTypeValue == PixelType.BayerRG8 || grabResult.PixelTypeValue == PixelType.BayerGR8)
                        {
                            ...
                            HOperatorSet.GenImageInterleaved(out ho_ImageNoglue, latestFrameAddress, "bgr",
                                    (HTuple)imageWidth, (HTuple)imageHeight, -1, "byte", (HTuple)imageWidth, (HTuple)imageHeight, 0, 0, -1, 0);

                        }
                        //HObject hrotaImg;
                        //HOperatorSet.GenEmptyObj(out hrotaImg);
                        //hrotaImg.Dispose();
                        //HOperatorSet.RotateImage(ho_Image,out hrotaImg,90,);
                        // 抛出图像处理事件
