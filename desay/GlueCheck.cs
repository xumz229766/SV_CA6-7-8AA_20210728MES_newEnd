...
namespace desay
{
    static class GlueCheck
    {
        ...
        //胶圈内圆
        private static HTuple hv_glueInnerCircle = new HTuple(531.0);
        ...
        private static bool action(Bitmap bmp_with_no_glue, Bitmap bmp_with_glue, HWindow Window)
        {
            ...
            //HOperatorSet.DispObj(ho_ImageT, Window);
