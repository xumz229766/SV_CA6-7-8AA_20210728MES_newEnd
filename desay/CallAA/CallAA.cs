...
namespace desay
{
    public class CallAA
    {
        ...
        [DllImport(str_AAFuntion_file, CallingConvention = CallingConvention.Cdecl, EntryPoint = "StartTestFunction")]
        public static extern void StartTestFunction(string szBarcode, string szJigSN);
