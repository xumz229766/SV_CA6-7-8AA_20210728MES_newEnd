...
namespace desay
{
    public partial class frmPasswordChange : Form
    {
        ...
        public frmPasswordChange()
        {
            ...
            comboBox_UserSelect.Items.Add(UserLevel.管理员.ToString());
        ...
        private void button_Yes_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBox_UserSelect.Text == UserLevel.管理员.ToString())
            {
                if (SecurityHelper.TextToMd5(textBox_OldPassword.Text.Trim()) == Config.Instance.SuperUserPassword)
                {
                    if (textBox_NewPassword.Text.Trim() == textBox_ConfirmPassword.Text.Trim())
                    {
                        Config.Instance.SuperUserPassword = SecurityHelper.TextToMd5(textBox_NewPassword.Text.Trim());
                        log.Debug("密码修改成功");
                        SerializerManager<Config>.Instance.Save(AppConfig.ConfigFileName, Config.Instance);
                        MessageBox.Show("密码修改成功");
        ...
        private void comboBox_UserSelect_SelectedIndexChanged(object sender, EventArgs e)
        {
