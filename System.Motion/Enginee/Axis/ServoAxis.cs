    ...
    public class ServoAxis : ApsAxis
    {
        ...
        public override double CurrentPos
        {
            get
            {
                ...
                //西威没有反馈
                return ApsController.GetCommandPosition(NoId) * Transmission.PulseEquivalent;
            }
        }
        /// <summary>
        ///     是否原点
        ...
        public override bool IsInPosition(double pos)
        {
            ...
            return ApsController.IsDown(NoId,true) & (CurrentPos + 0.10 >= pos & CurrentPos - 0.10 <= pos);
        }
    }
}