...
namespace Motion.Enginee
{
    ...
    public class DoubleCylinder : Cylinder, ICylinderStatusJugger
    {
        ...
        private bool NoOriginAlarm()
        {
            ...
            //无原点报警
            if ((cylinderNoOrigin && alarmDelayDone) || (_noOriginAlarm && !Condition.External.AlarmReset))
                _noOriginAlarm = true;
        ...
        private bool NoMoveAlarm()
        {
            ...
            //无动点报警
            if ((cylinderNoMove && alarmDelayDone) || (_noMoveAlarm && !Condition.External.AlarmReset))
                _noMoveAlarm = true;
        ...
        private bool OnOriginAlarm()
        {
            ...
            //气缸ON时，原点信号报警
            if ((cylinderOnOrigin && alarmDelayDone) || (_onOriginAlarm && !Condition.External.AlarmReset))
                _onOriginAlarm = true;
