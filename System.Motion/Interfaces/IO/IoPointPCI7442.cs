...
namespace Motion.Interfaces
{
    ...
    ///     表示一个通讯开关量。
    /// </summary>
    public class IoPointPCI7442 : Automatic
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        public IoPointPCI7442(ISwitchControllerPCI7442 controller, int boardNo,int readPortNo,int portNo, IoModes ioMode)
        {
            Controller = controller;
            BoardNo = boardNo;
            ReadProtNo = readPortNo;
            PortNo = portNo;
            IoMode = ioMode;
        }
        ...
        ///     读写控制器
        /// </summary>
        protected ISwitchControllerPCI7442 Controller { get; private set; }
